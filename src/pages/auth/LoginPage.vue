<template>
  <div class="login-page">
    ...
    <div class="login-page__form-wrapper">
      <q-form ref="loginFormRef" class="login-page__form login-form" @submit.prevent.stop="onSubmit">
        <div class="login-page__btn-toggle btn-toggle">
          <q-btn-toggle
            ...
            :options="[
            {label: 'Рекламодатель', value: 1},
            {label: 'Рекламное агенство', value: 2}
          ]"
          ></q-btn-toggle>
        </div>
      ...
      <div class="login-page__links">
        ...
        <router-link to="/auth/forget-password">Забыли пароль?</router-link>
      </div>
    </div>
  </div>
</template>
...
// import {Validate} from 'src/composable/validateErrors.composable';
